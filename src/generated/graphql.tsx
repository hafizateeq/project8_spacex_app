...
export type MissionsInfoQuery = { __typename?: 'Query', launches?: Maybe<Array<Maybe<{ __typename?: 'Launch',flight_number?: Maybe<number>, mission_name?: Maybe<string>, mission_id?: Maybe<Array<Maybe<string>>>, launch_year?: Maybe<number>, launch_success?: Maybe<boolean> }>>> };

export type LauncheMissionInfoQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LauncheMissionInfoQuery = { __typename?: 'Query', launch?: Maybe<{ __typename?: 'Launch',flight_number?: Maybe<number>, mission_name?: Maybe<string>, launch_year?: Maybe<number>, launch_success?: Maybe<boolean>, details?: Maybe<string>, launch_site?: Maybe<{ __typename?: 'LaunchSite', site_name?: Maybe<string> }>, rocket?: Maybe<{ __typename?: 'LaunchRocket', rocket_name?: Maybe<string>, rocket_type?: Maybe<string> }>, links?: Maybe<{ __typename?: 'LaunchLinks', flickr_images?: Maybe<Array<Maybe<string>>> }> }> };
...
export const LauncheMissionInfoDocument = gql`
...
/**
 * __useLauncheMissionInfoQuery__
 *
 * To run a query within a React component, call `useLauncheMissionInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLauncheMissionInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLauncheMissionInfoQuery(baseOptions: Apollo.QueryHookOptions<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>(LauncheMissionInfoDocument, options);
      }
export function useLauncheMissionInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>(LauncheMissionInfoDocument, options);
        }
export type LauncheMissionInfoQueryHookResult = ReturnType<typeof useLauncheMissionInfoQuery>;
export type LauncheMissionInfoLazyQueryHookResult = ReturnType<typeof useLauncheMissionInfoLazyQuery>;
export type LauncheMissionInfoQueryResult = Apollo.QueryResult<LauncheMissionInfoQuery, LauncheMissionInfoQueryVariables>;